...
public class Blacksmith implements ShopInterface, Serializable{
    ...
    /*
     * Function for purchasing item. Checks vectors through iterator until valid item is found.
     * If team has enough money, item is purchased. If gladiator had previous equipment in same slot,
     * its price is halved and subtracted from new item's price.
     */
